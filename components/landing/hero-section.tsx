...
export function HeroSection() {
  return (
    <section className="flex flex-col items-center px-4 pt-24 pb-14 text-center">
      <BlurFade delay={0.1}>
      ...
      <BlurFade delay={0.3}>
        <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-zinc-600 sm:text-lg sm:leading-8 dark:text-zinc-300">
          Organize tasks in boards, move cards with drag-and-drop, and stay in sync with your team
          in real time — so nothing falls through the cracks.
        </p>
      </BlurFade>
